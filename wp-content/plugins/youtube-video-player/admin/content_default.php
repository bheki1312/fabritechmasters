	...
	?>
        ...
        <table class="wp-list-table widefat fixed posts youtube_settings_table" style="width:75%; min-width:820px !important;table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>
                    <td>     
                    	Autoplay: <span title="Set this option if you want automatically start playing videos" class="desription_class">?</span>
                    </td>
                ...
                <tr>
                    <td>     
                    	Show Fullscreen button: <span title="Set this option if you want to show fullscreen button on YouTube video player" class="desription_class">?</span>
                    </td>
                    <td class="radio_input">     
                ...
                <tr>                     
                	<td>     
                    	Show related videos: <span class="pro_subtitle_span">Pro feature!</span> <span title="Set this option if you need to show related videos after the YouTube video ends." class="desription_class">?</span>
                    </td>
                    <td class="radio_input">     
                ...
                <tr>
                 ...
                 <tr>
                    <td>     
                    	Auto-hide parameters: <span title="Set this option if you need Autohide Parameters" class="desription_class">?</span>
                    </td>
                ...
                <tr>
                    <td>     
                    	Player Initial Volume: <span title="Choose initial volume level for YouTube videos" class="desription_class">?</span>
                    </td>
                    <td>     
